...
#define TIME_INI (float) 0.000E3 // 1.00E3 // 10.E3 //
#define TIME_STEADY (float) 5.000E3 //  2.0E3 // 10.E3 //

#define DURATION (float) 12.00E3 // 10.E3 //

#define TIME_WINDOW (float) 0.0500E3 // 1.00E3 // 10.E3 //
#define TIME_REC (float) 30.00E3 // 1.00E3 // 10.E3 //
#define TIME_REC_SPIKES (float) 10.00E3 // 1.00E3 // 10.E3 //
...
#define IF_NO_QUENCH 1
// whether to have quench disorder or not
///////////
//Ring
///////////
#define IF_RING 1
...
const float kappas[4] = {KAPPA, (float) KAPPA * (float) 1.0 ,  KAPPA * (float) 0.85,  (float) KAPPA * (float) 1.0} ;
...
#define IF_SAVE_SPARSE_REP_FF 1

#define N_POISSON 32000
#define REC_FF 1

#define K_FF (float) 2000
#define GAIN_FF (float) 0.5
...
#define KAPPA_DIST (float) 1.0
#define PHI_DIST (float) 0.75

#define KAPPA_CUE (float) 0.25
#define KAPPA_TEST (float) 1.0
