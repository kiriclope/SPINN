...
#+begin_src ipython
  session = '/'
  session = '/LR_Go_early_phi_0_ini_0'
...
:RESULTS:
: (28,)
[[file:./.ob-jupyter/ae684e2e9c23ba7afe3cc1406197d361785a5c1a.png]]
:END:
...
#+RESULTS:
:RESULTS:
: /tmp/ipykernel_962795/3551809589.py:16: RuntimeWarning: invalid value encountered in divide
:   ax[1].plot(times, m1 / m0)
[[file:./.ob-jupyter/fd338dc9e8fcc2d2831b43f41e9df081ee48965d.png]]
:END:
...
#+RESULTS:
[[file:./.ob-jupyter/460520178b0dd946d25406256bc43e005add4b40.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/513294c611b7436f612df12a8621a8bd50955160.png]]
